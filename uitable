...
page1:Label("Auto Farm Function")

page1:Toggle("Toggle")

local lockfarm1 = page1:Toggle("Toggle Lock")
...
page2:Label("Settings Auto Farm")
local SelectWeapon = page2:Drop("Select Weapon / Combat",false,Wapon,function(Value)
...
page2:Button("Refresh Weapon / Combat",function()
   ...
   page1:Slider("Slider",false,false,0,100,10,1,false,10,function()
       print()
   end)
